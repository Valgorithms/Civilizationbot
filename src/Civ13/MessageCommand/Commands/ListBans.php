...
{
    // Header section
    protected const string TITLE = 'Civ13 Bans List';

    // Description section
    protected const string DESCRIPTION_TEXT = 'Retrieves the bans.txt files for locally hosted Civ13 servers.';
