...
class Civ13
{
    ...
    */
    ...
    {
        if (isset($this->rounds[$server][$game_id]) && isset($this->current_rounds[$server]) && $game_id !== $this->current_rounds[$server]) //If the round already exists and is not the current round
