    ...
    $webpage_content = function ($return) use ($civ13, $port, $sub) {
        return '<meta name="color-scheme" content="light dark"> 
                <div class="button-container">
                    ...
                    <button style="background-color: black; color:white; display:flex; justify-content:center; align-items:center; height:100%; width:68%; flex-grow: 1;" onclick="window.open("'. addslashes($civ13->github) .'")">' . $civ13->discord->user->displayname . '</button>
                </div>
